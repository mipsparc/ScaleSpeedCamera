...
# 使用手順
- https://twitter.com/mipsparc/status/1363758162214588416 を見て、使い方の概要を把握する
- 「地点検知用紙.png」をA4サイズで印刷して、切り出して直線レール沿いに置きます。
...
- しばらく黒い画面が表示されます。
- カメラ映像が表示されますので、ノートPCの場合は半分閉じてカメラにQRコードと線路が映るようにしてください。
- QRコードの上に縦線と、2本の横線が表示されれば正常です。
- 横線の中が検知領域になっています。計測する線路を横線の中に含めてください。
