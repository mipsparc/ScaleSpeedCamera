...
- ノートPCのインカメラでも動作しますが、理想的には60fps対応の外付けカメラの場合高精度で計測できます
...
- 希望のサイズ(小さいほど精度が高く、大きいほど読み取りやすいです)を切り出して直線レール沿いに置きます。
- ただし、HOの場合はバーコード間隔150mmはおすすめしません。外付けカメラで300mm以上だと十分な精度が得られます。
...
## 起動手順
- しばらく黒い画面が表示されます。
- カメラが複数有る場合は、どれにするか選択していただきます。0や1などを入力してEnterキーを押してください
- カメラ映像を「ピクチャ」フォルダに保存するか選択していただきます。保存してよければEnterキーを押してください。
- カメラ映像が表示されます。
...
- Height: 検知領域の上下幅の大きさです。調整して、車両全体が映るようにしてください。
- Barcode: バーコードの間隔を150mm以外にするときに調整してください。HOの場合、150mmではなく、300mm以上で高いところから計測するのをおすすめします。
